package com.minimajack._v8.stream;

import java.io.IOException;
import java.io.InputStream;

import com.minimajack._v8.format.BlockHeader;

public class V8InputStream extends InputStream{
	...
	public V8InputStream(BlockHeader iph) throws IOException {
